...
const Committee = () => {
    return (
        <>
            <section id="about-comsnets" className="bg-slate-50 dark:bg-slate-800 mt-16">
                    ...
                    <div className="my-8">
                        <div className="md:w-8/12 mx-auto text-center">
                            ...
                            <p className="text-slate-500 mt-2 mb-6">
                                ...
                                industry, practitioners, and business leaders, providing a forum for discussing cutting edge research, and directions for new innovative business and technology.
                                <br />
                                <br />
                                The conference will include a highly selective technical program consisting of submitted papers, a small set of invited papers on important and timely topics from well-known leaders in the field, and poster
                                session of work in progress. Focused workshops and panel discussions will be held on emerging topics to allow for a lively exchange of ideas. International business and government leaders will be invited to
                                share their perspectives, and will complement the technical program.
                            </p>
                        </div>
                    </div>
                </div>
