...
class Home extends React.Component {
    render() {
        return (
            <>
                <Layout>
                    <div className="min-h-screen mt-20 flex space-y-4 flex-col mx-20 text-center justify-center">
                        ...
                        <p>
                            All the information on this website - gatheringinbali.com - is published in good faith and for general information purpose only. GatheringInBali does not make any warranties about the completeness, reliability
                            and accuracy of this information. Any action you take upon the information you find on this website (GatheringInBali), is strictly at your own risk. GatheringInBali will not be liable for any losses and/or
                            damages in connection with the use of our website. Our Disclaimer was generated with the help of the <a href="https://www.termsfeed.com/disclaimer-generator/">Disclaimer Generator</a>.
                        </p>
