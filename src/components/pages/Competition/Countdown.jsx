...
const Countdown = () => {
  const countdown = () => {
    ...
    updateCountdownElement("days-competition", timeDays);
    updateCountdownElement("hours-competition", timeHours);
    updateCountdownElement("minutes-competition", timeMinutes);
    updateCountdownElement("seconds-competition", timeSeconds);
        ...
        <div className="h-auto bg-transparent text-center w-10/12 md:w-8/12 -mt-28 mx-auto">
          <div className="w-10/12 md:w-8/12 bg-white dark:bg-slate-800 border-b-8 border-indigo-500 rounded-lg z-10 absolute shadow-card2">
            <div className="w-11/12 mx-auto py-6 border-b border-gray-300">
              <h3 class="text-lg uppercase font-bold text-center text-gray-500 dark:text-gray-400 sm:text-lg -mb-2">Final Phase - Final Presentation will be held in</h3>
