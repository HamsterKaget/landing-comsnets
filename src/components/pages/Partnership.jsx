...
import { partner, partnerMarketing, partnerStrategic } from "../data/partner_sponsor";
      ...
      <>
        <Layout>
          <div className="min-h-screen">
            ...
            <div className="container max-w-[80vw] mb-8 rounded-lg bg-white dark:bg-slate-800 dark:text-slate-50 mx-auto min-h-[25vh] h-full -mt-32 pb-12 shadow-lg flex flex-col items-center">
              {/* Strategic Partner */}
              <div className="mt-10 mb-6 w-full lg:px-96 text-center">
                <h2 className="text-3xl font-bold uppercase mb-2">strategic partner</h2>
                ...
                {partnerStrategic.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center pb-10 pt-5 px-1.5">
                      ...
                      <div className="w-28 h-28 overflow-hidden bg-white rounded-full shadow-lg">
              ...
              {/* Operational Partner */}
              <div className="mt-10 mb-6 w-full lg:px-96 text-center">
                <h2 className="text-3xl font-bold uppercase mb-2">Organizing Partner</h2>
                <hr className="opacity-75 mx-auto" style={{ width: "76%" }} />
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mx-8 text-center">
                {/* card */}
                {partner.map((item) => (
                  // <div className="relative w-full min-w-[250px] max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" key={item.name}>
                  <div
              ...
              <div className="mt-10 mb-6 w-full lg:px-96 text-center">
                <h2 className="text-3xl font-bold uppercase mb-2">Digital Marketing Partner</h2>
                <hr className="opacity-75 mx-auto" style={{ width: "76%" }} />
              </div>
