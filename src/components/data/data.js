...
export const introEvents = [
  {
    ...
    title: "Introduction",
    desc1:
      "Welcome to our website, where innovation meets inspiration in the realm of digital transformation. We are excited to introduce our upcoming event, a transformative gathering that combines the power of a workshop, coaching and mentoring sessions, panel discussion, and a cutting-edge conference, all centered around the theme of <strong>Digital Transformation.</strong>",
    desc2:
...
export const topic = [
  {
    ...
    desc1: "In this rapidly evolving digital age, the significance of digital transformation cannot be overstated. Our event focuses on this pivotal topic, shedding light on its importance, relevance, and the opportunities it presents.",
    desc2:
...
export const targetAudience = [
  {
    ...
    desc1: "The target audience for our events includes  Industries / Corporate, Government Stake Holders, Associations, Researchers, Academics and Public who are interested in the field of communication systems and networks.",
    ...
    desc3:
      " This can include individuals from a range of fields, such as computer science, electrical engineering, telecommunications, and information technology. The conference is open to participants from all over the world who are interested in these areas of research and development.",
  },
];
...
export const pricing = [
  ...
  },
  {
    ...
    features: ["Full day meeting package", "Merchandise", "Certificate of Attendance", "Coaching and Mentoring Session"],
    cta: "Buy Now",
    href: "https://shop.gatheringinbali.com/events/detail/comsnets-bali-2023-day-1-pass",
    mostPopular: false,
  },
  // {
  //     title: "Full Day Pass",
