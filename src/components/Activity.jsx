        ...
        <>
            <section id="activity" className="bg-slate-50 dark:bg-slate-800">
                <div className="container h-auto mx-auto mt-8 p-4 pb-16">
                    ...
                    <div className="text-left grid grid-cols-12 gap-5 gap-y-10 mt-14 mx-2 sm:mx-6">
                        {activities.map((activity) => (
                            <div className="hover:-translate-y-4 h-auto col-span-12 lg:col-span-4 sm:col-span-6 p-4 mt-4 rounded-lg shadow-card hover:shadow-card2 bg-white dark:bg-slate-700 dark:hover:bg-indigo-600 hover:bg-indigo-600 group transition-all duration-300 ease-in">
                                <div className="ml-2 -mt-12 bg-indigo-500 p-4 rounded-full inline-block text-white group-hover:rotate-[360deg] group-hover:text-indigo-500  group-hover:bg-white border-2 border-indigo-500 dark:group-hover:bg-slate-600 transition-all duration-300 ">
