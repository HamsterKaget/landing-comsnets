                                            ...
                                            {nav.subMenu && (
                                                <ul className="absolute bg-white shadow-lg rounded-md w-48 dark:bg-slate-800 dark:text-white">
                                                    {nav.subMenu.map((subNav) => (
                                                        <li
                                                            key={subNav.name}
                                                            className={`px-4 py-2 hover:bg-indigo-600 hover:text-white duration-300 first:rounded-tr-md last:rounded-b-md ${nav.mobileMenu ? "block md:hidden" : "hidden md:block"}`}
                                                        >
